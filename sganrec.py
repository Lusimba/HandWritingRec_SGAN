...
def define_discriminator(in_shape = (28, 28, 1), n_classes = 10):
    ...
    #define and compile supervised discriminator models
    c_model = Model(in_image, c_out_layer)
    c_model.compile(loss = 'sparse_categorical_crossentropy', optimizer = Adam(lr = 0.0002, beta_1 = 0.5), metrics = ['accuracy'])
    # Unsupervised output 
    d_out_layer = Lambda(custom_activation)(fe)
    # define and compile unsupervised discriminator models
...
def define_gan(g_model, d_model):
    ...
    # connect the image output from generator as input to discriminator
    gan_output = d_model(g_model.output)
    #define gan model as taking noise and outputting as classification
...
def select_supervised_samples(data, n_samples = 100, n_classes = 10):
    X,y = dataset
